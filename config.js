module.exports = {
	...
	adminId: "325399199363497985", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "NzMyMzA0OTk5OTU4NDQ2MTEx.GPMVtX.Nxq_efPdMOZo7ef2YPe_bTaIofMisG6AcLplKM", //- Bot's Token
	clientId: process.env.clientId || "4cb2058dfdb94bf99c2b8bf2d94b9fd3", //- ID of the bot
	clientSecret: process.env.clientSecret || "e6b18781264f47ffbd5535bc3a2cabac", //- Client Secret of the bot
